...
export default function Register(){
  ...
  return (<div className='p-4 max-w-md mx-auto'><h1 className='text-xl font-bold mb-4'>Register</h1>
  ...
  <button onClick={submit} className='px-4 py-2 rounded bg-blue-600 text-white'>Create account</button>
